                                    ...
                                    <div key={i} className={`bg-white p-5 rounded-xl border shadow-sm transition hover:shadow-md ${rec.ticketId ? 'border-green-200 bg-green-50/30' : 'border-slate-200'}`}>
                                        <div className="flex justify-between items-start mb-3">
                                            <div className="flex items-center gap-2">
                                                <span className={`px-2 py-1 rounded-md text-xs font-bold border ${rec.method === 'GET' ? 'bg-blue-50 text-blue-700 border-blue-100' : 'bg-green-50 text-green-700 border-green-100'}`}>
                                                    {rec.method}
                                                </span>
